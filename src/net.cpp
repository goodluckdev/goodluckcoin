...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("GoodLuckCoin-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("GoodLuckCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "GoodLuckCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("GoodLuckCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("GoodLuckCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("GoodLuckCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("GoodLuckCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. GoodLuckCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("GoodLuckCoin-start");
