...
static const int64_t nTargetTimespan = 60 * 10;  // 10m
unsigned int nTargetSpacing = 1 * 30; // 30 sec
...
unsigned int nModifierInterval = 10 * 60; // GoodLuckCoin - time to elapse before new modifier is computed
...
const string strMessageMagic = "GoodLuckCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight == 1)
    {
    	...
    	else if(pindexBest->nHeight < 350)
    {
        nSubsidy = 0 * COIN;
    }
        ...
        else if(pindexBest->nHeight < 7500)
    {
        ...
        else if(pindexBest->nHeight < 11500)
    {
        nSubsidy = 100 * COIN;
    }
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 20000) // 15000 - 20000
    {
        nSubsidy = 21 * COIN;
    }
        else if(pindexBest->nHeight < 32500)
    {
        ...
        else if(pindexBest->nHeight < 33000)
    {
        nSubsidy = 151 * COIN;
    }
        else if(pindexBest->nHeight < 38000)
    {
        nSubsidy = 31 * COIN;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GoodLuckCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Good Luck Coin - BBC.COM 21 May 2015 Mazda and Mitsubishi recall more cars";
        CTransaction txNew;
        txNew.nTime = 1432293478;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1432293478;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 16214715;
       ...
       if (false && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("0x2f21f1564a44f259b732076cb5643c38e68470f8a3739f71892b382335b162d5"));
